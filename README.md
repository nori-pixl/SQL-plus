...
"editor.tokenColorCustomizations": {
    "textMateRules": [
        {
            "scope": "keyword.control.sqlp",
            "settings": { "foreground": "#C586C0", "fontStyle": "bold" } // js.ifなどの制御系（紫）
        },
        {
            "scope": "entity.name.function.sqlp",
            "settings": { "foreground": "#DCDCAA" } // add, readなどの関数（黄色）
        },
        {
            "scope": "variable.other.sqlp",
            "settings": { "foreground": "#9CDCFE" } // リスト名や変数（水色）
        },
        {
            "scope": "string.quoted.sqlp",
            "settings": { "foreground": "#CE9178" } // "テキスト"（オレンジ）
        }
    ]
},
"files.associations": {
...
```
vscodeの setting.json に取り付けてください
